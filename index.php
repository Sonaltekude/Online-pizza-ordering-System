...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
              <h3><i>Online Pizza Ordering <i></h3>
    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © <?= date("Y") ?> - <?= $_SESSION['setting_name'] ?> | <a href="mailto:oretnom23@mail.com" target="_blank">pizzaorder@gmail.com</a></div></div>
        </footer>
